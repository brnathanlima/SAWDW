	                    ...
	                    <div class="col-md-12">
	                        <div class="card">
	                            ...
	                            <div class="content">
	                            	<c:choose>
										<c:when test="${empty gerente.id}">
											<form action="gerente" method="post" data-toggle="validator" role="form">
												<div class="row">
			                                        <div class="col-md-12">
											...
											<form action="gerente" method="post" data-toggle="validator" role="form">
												<div class="row">
			                                        <div class="col-md-12">
			                                            <div class="form-group has-feedback">
			                                                <label class="control-label" for="matricula">Matricula</label>
			                                                <input type="number" id="matricula" name="matricula" value="${gerente.matricula}" 
			                                    ...
			                                    <div class="row">
			                                        <div class="col-md-6">
			                                            <div class="form-group has-feedback">
			                                                <label class="control-label" for="nome">Nome</label>
			                                                <input type="text" id="nome" name="nome" value="${gerente.nome}" 
			                                        ...
			                                        <div class="col-md-6">
			                                            <div class="form-group has-feedback">
			                                                <label class="control-label" for="sobrenome">Sobrnome</label>
			                                                <input type="text" id="sobrenome" name="sobrenome" value="${gerente.sobrenome}" 
			                                                class="form-control" required>
			                                            </div>
			                                        </div>
			                                    </div>			                                    
			                                    <div class="row">
			                                        <div class="col-md-6">
			                                            <div class="form-group has-feedback">
			                                                <label class="control-label" for="email">E-mail</label>
			                                                <input type="text" id="email" name="email" value="${gerente.email}" 
			                                                class="form-control" required>
			                                            </div>
			                                        </div>
			                                        <div class="col-md-6">
			                                            <div class="form-group has-feedback">
			                                                <label class="control-label" for="telefone">Telefone</label>
			                                                <input type="text" id="telefone" name="telefone" value="${gerente.telefone}" 
			                                    ...
			                                    <div class="row">
			                                        <div class="col-md-12">
			                                            <div class="form-group has-feedback">
			                                                <label class="control-label" for="departamento">Departamento</label>
			                                                <input type="text" id="departamento" name="departamento" value="${gerente.departamento}" 
			                                                class="form-control" required>
			                                            </div>
			                                        </div>
			                                    </div>			                                    
			                                    <div class="row">
			                                        <div class="col-md-4">
			                                            <div class="form-group has-feedback">
			                                                <label class="control-label" for="nomeDeUsuario">Nome de Usuário</label>
			                                                <input type="text" id="nomeDeUsuario" name="nomeDeUsuario" value="${gerente.nomeDeUsuario}" 
			                                                class="form-control" pattern="[a-z,0-9]+$" required>
			                                                <span class="help-block">Apenas letras e números.</span>
			                                            </div>
			                                        </div>
			                                        <div class="col-md-4">
			                                            <div class="form-group has-feedback">
			                                                <label class="control-label" for="senha">Senha</label>
			                                                <input type="password" id="senha" name="senha" value="${gerente.senha}"
			                                                class="form-control" required>
			                                                <span class="help-block">No mínimo 6 dígitos.</span>
			                                        	</div>
			                                        </div>
			                                        <div class="col-md-4">
				                                    	<div class="form-group has-feedback">
				                                    	    <label class="control-label" for="confirmarSenha">Confirmar a senha</label>
				                                            <input type="password" id="confirmarSenha" name="confirmarSenha"  value="${gerente.senha}" 
			                                    ...
			                                    <div class="row">
			                                        ...
			                                        <div class="col-md-6">
			                                            <div class="form-group"> 
			                                                ...
			                                                <c:choose>
			                                                	<c:when test="${not empty gerente.dataDeModificacao}">
