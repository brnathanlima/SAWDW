	                    ...
	                    <div class="col-md-12">
	                        <div class="card">
	                            ...
	                            <div class="content">
	                            	<c:choose>
										<c:when test="${empty superAdministrador.id}">
											<form action="superAdministrador" method="post" data-toggle="validator" role="form">
			                                    <div class="row">
			                                        <div class="col-md-6">
			                                    ...
			                                    <div class="row">
			                                        <div class="col-md-4">
			                                            <div class="form-group has-feedback">
			                                                <label class="control-label" id="nomeDeUsuario">Nome de Usuário</label>
			                                                <input type="text" id="nomeDeUsuario" name="nomeDeUsuario" class="form-control" pattern="[a-z,0-9]+$" required />
											...
											<form action="superAdministrador" method="post" data-toggle="validator" role="form">
			                                    <div class="row">
			                                        <div class="col-md-6">
			                                            <div class="form-group has-feedback">
			                                                <label class="control-label" for="nome">Nome</label>
			                                                <input type="text" id="nome" name="nome" class="form-control" value="${superAdministrador.nome}" required />
			                                            </div>
			                                        </div>
			                                        <div class="col-md-6">
			                                            <div class="form-group has-feedback">
			                                                ...
			                                                value="${superAdministrador.sobrenome}" required />
			                                            </div>
			                                        </div>
			                                    </div>
			                                    ...
			                                    <div class="row">
			                                        <div class="col-md-6">
			                                            <div class="form-group has-feedback">
			                                                ...
			                                                value="${superAdministrador.email}" required />
			                                            </div>
			                                        </div>
			                                        <div class="col-md-6">
			                                            <div class="form-group has-feedback">
			                                                <label class="control-label" for="telefone">Telefone</label>
			                                                <input type="text" id="telefone" name="telefone" class="form-control telefone"
			                                                pattern="\([0-9]{2}\) [0-9]{4,5}-[0-9]{4}$" data-mask-reverse="true" 
			                                                value="${superAdministrador.telefone}" required />
			                                            </div>
			                                        </div>
			                                    </div>
			                                    <div class="row">
			                                        <div class="col-md-4">
			                                            <div class="form-group has-feedback">
			                                                <label class="control-label" id="nomeDeUsuario">Nome de Usuário</label>
			                                                <input type="text" id="nomeDeUsuario" name="nomeDeUsuario" class="form-control" pattern="[a-z,0-9]+$" 
			                                                value="${superAdministrador.nomeDeUsuario}" required />
			                                                <span class="help-block">Apenas letras e números.</span>
			                                            </div>
			                                        </div>
			                                        <div class="col-md-4">
			                                            <div class="form-group has-feedback">
			                                                <label class="control-label" for="senha">Senha</label>
			                                                <input type="password" id="senha" name="senha" class="form-control" data-min-length="6" 
			                                                minlength="6" value="${superAdministrador.senha}" required />
			                                                <span class="help-block">No mínimo 6 dígitos.</span>
			                                            </div>
			                                        </div>
			                                        <div class="col-md-4">
			                                            <div class="form-group has-feedback">
			                                                ...
			                                                value="${superAdministrador.senha}"required />
			                                            </div>
			                                        </div>
			                                    </div>
			                                    <div class="row">
