...
public class AdministradorDeInstituicaoDAO extends GenericoDAO {
	...
	public void adicionar(AdministradorDeInstituicao administradorDeInstituicao) {
	...
	public void editar(AdministradorDeInstituicao administradorDeInstituicao) {
	...
	public Object autenticarUsuario(String nomeDeUsuario, String senha) {
		...
		try {
			...
			ps.setString(3, "administradorDeInstituicao");
